    ...
    <>
      ...
      {isLoading ? (
        <div className="skeleton-list">
           <Skeleton />   {/* скелетон потрібен для відображення фейкової загрузкиб показує наче що зараз загружаються блоки данних */}
          <Skeleton />
          <Skeleton />
        </div>
      ) : (
      ...
      <button className="send-invite-btn">Відправити запрошення</button>
    </>
  );
};
